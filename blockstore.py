...
class BlockStore:
    ...
    def store_block_content(self, block_id: bytearray, content: bytearray):
        self.content_db.put(block_id, content)

    def get_block_content(self, block_id: bytearray | bytes):
        return self.content_db.get(block_id)

    def get_block_author(self, block_id: bytearray):
        return self.authors_db.get(block_id)

    def store_block_author(self, block_id: bytearray, author: bytearray):
