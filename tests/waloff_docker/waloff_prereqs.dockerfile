...
# RUN for python_package in /opt/PriBlocks/tests/waloff_docker/python_packages/*; do pip install --break-system-packages --root-user-action ignore "$python_package"; done
